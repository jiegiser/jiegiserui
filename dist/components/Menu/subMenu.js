...
export var SubMenu = function (_a) {
    ...
    var isOpened = (index && context.mode === 'vertial') ? openedSubMenus.includes(index) : false;
    ...
    var renderChildren = function () {
        var subMenuClasses = classNames('jiegiser-submenu', {
    ...
    return (React.createElement("li", __assign({ key: index, className: classes }, hoverEvents),
        React.createElement("div", __assign({ className: "submenu-title" }, clickEvents),
            title,
            React.createElement(Icon, { icon: "angle-down", className: "arrow-icon", style: iconStyle })),
        renderChildren()));
};
