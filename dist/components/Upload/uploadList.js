...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "jiegiser-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { key: item.uid, className: "jiegiser-upload-list-item" },
